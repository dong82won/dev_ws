...
# --- 2. 재귀적으로 찾은 파일들 추가 (리스트 병합) ---
# worlds 폴더 구조 유지
data_files_list += get_recursive_data_files('worlds', os.path.join('share', package_name))
# models 폴더 구조 유지
data_files_list += get_recursive_data_files('models', os.path.join('share', package_name))
...
setup(
    ...
    data_files=data_files_list, # type: ignore  # 위에서 정리한 변수를 전달
